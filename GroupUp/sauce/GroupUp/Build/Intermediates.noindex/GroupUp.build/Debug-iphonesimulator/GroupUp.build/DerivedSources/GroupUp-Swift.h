...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="GroupUp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7GroupUp11AppDelegate")
...
@interface MapChatViewController : UIViewController <UITableViewDataSource, UITableViewDelegate>
...
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified travelGroupTable;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC7GroupUp11TravelGroup")
@interface TravelGroup : UITableViewCell
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified TravelImage;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified TravelLabel;
- (void)awakeFromNib;
...
SWIFT_CLASS("_TtC7GroupUp30TravelGroupTableViewController")
@interface TravelGroupTableViewController : UITableView
